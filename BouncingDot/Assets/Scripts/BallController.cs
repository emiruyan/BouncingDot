...
public class BallController : MonoBehaviour
{
   ...
   private void OnCollisionEnter2D(Collision2D other)//Çarpışma olduğunda topa güç uyguluyoruz.
   {
      rb.velocity = Vector3.up * _jumpForce;//Vector3.up ile jumpForce değerini velocity'e atadık.
